...
MoveFlow provides skills, agents, hooks, and an MCP server for developing, testing, and formally verifying [Move](https://aptos.dev/en/build/smart-contracts) smart contracts on [Aptos](https://aptos.dev). Version 1.0.0.
